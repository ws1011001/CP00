## ---------------------------
## [script name] ed01_stimuli_selection_v1.R 
##
## SCRIPT to select words as stimuli for the cross-modal repetition task in the fMRI study. [1st version].
##
## By Shuai Wang, [date] 2019-10-29
##
## ---------------------------
## Notes:
