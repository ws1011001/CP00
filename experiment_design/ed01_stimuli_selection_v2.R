## ---------------------------
## [script name] ed01_stimuli_selection_v2.R 
##
## SCRIPT to select words as stimuli for the cross-modal repetition task in the fMRI study. [2nd version].
##
## By Shuai Wang, [date] 2019-11-05
##
## ---------------------------
## Notes:
...
lexique.words <- read.csv('Lexique_Words_v2.csv')
