...
## output
# save R data
save(list=ls(),file=file.path(odir,'Stimulation_task-VisualLocalizer_Pilot3.Rdata'))
# output timings
sink(file=file.path(odir,'Stimulation_task-VisualLocalizer_Pilot3.stat'),append=FALSE)
...
sink()
# output LabView .desc
write.table(vloc.desc,file=file.path(odir,'Stimulation_task-VisualLocalizer_Pilot3.desc'),
            sep='\t',row.names=FALSE,quote=FALSE)  # UTF-8
write.table(vloc.desc,file=file.path(odir,'Stimulation_task-VisualLocalizerFr_Pilot3.desc'),
