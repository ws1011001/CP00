#!/usr/bin/env python
## ---------------------------
## [script name] ps32_gMVPA_AudioVisAssos1word_searchlight_classification_nilearn.py
...
f_roi = os.path.join(dir_mvpa, 'group_masks_labels-searchlight.csv')  # ROIs info
